    ...
    while (1) {
      switch ((_context.prev = _context.next)) {
        ...
        case 5:
          ...
          (_removeRoomORPlayer = removeRoomORPlayer(public_rooms, player_id)),
            (roomsPublic = _removeRoomORPlayer.newRooms),
            (removedPublic = _removeRoomORPlayer.removed);
          (_removeRoomORPlayer2 = removeRoomORPlayer(private_rooms, player_id)),
            (roomsPrivate = _removeRoomORPlayer2.newRooms),
            (removedPrivate = _removeRoomORPlayer2.removed);
          UpadateRoom(roomsPublic, true);
          UpadateRoom(roomsPrivate, false);
          removed = [].concat(
            _toConsumableArray(removedPublic),
            _toConsumableArray(removedPrivate)
          );
          EventLogger(removed);
